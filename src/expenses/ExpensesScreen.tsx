    ...
    <div className="space-y-6">
      ...
      <div className="bg-card border border-border rounded-lg">
        <Table>
          ...
          <TableBody>
            {isLoading ? (
              <TableRow><TableCell className="py-6" colSpan={9}>Cargando...</TableCell></TableRow>
            ) : filtered.length === 0 ? (
              <TableRow><TableCell className="py-6" colSpan={9}>No hay gastos</TableCell></TableRow>
            ) : (
              filtered.map((e) => (
                <TableRow key={e.id}>
                  ...
                  <TableCell className="text-right">{e.base_amount.toFixed(2)}€</TableCell>
                  <TableCell className="text-right">{e.vat_amount.toFixed(2)}€</TableCell>
                  <TableCell className="text-right">{e.total.toFixed(2)}€</TableCell>
