      ...
      <div className="min-h-screen w-full flex items-start justify-center py-12 px-4 md:px-6">
        <div className="w-full max-w-3xl">
          ...
          <Card className="p-6 md:p-8   space-y-6">
            ...
            <section className="space-y-2">
              <h2 className="text-xl font-semibold text-foreground">3. Cómo usamos la información</h2>
              <p className="text-foreground/90">
            ...
            <section className="space-y-2">
              ...
              <p className="text-foreground/90">
                Para consultas sobre esta Política de Privacidad, contáctanos en <span className="text-primary">privacidad@invoicer.app</span>.
              </p>
            </section>
          </Card>
        </div>
