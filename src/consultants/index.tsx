            ...
            <Table className="w-full">
              <TableHeader>
                <TableRow className="border-b border-[#FFFFFF14]">
                  ...
                  <TableHead className="text-left py-4 px-2 text-sm font-medium text-[#A1A1AA] uppercase tracking-wider">NIF</TableHead>
              ...
              <TableBody>
                {isLoading ? (
                  ...
                  <TableRow className="border-b border-[#FFFFFF14]"><TableCell className="py-6 px-2" colSpan={6}>No hay consultores</TableCell></TableRow>
                ) : (
                  filtered.map((c) => (
